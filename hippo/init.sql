alter user postgres with login password 'welcome1';

create table employee (empid int, first_name varchar(40), last_name varchar(40), status varchar(10), hiredt date, terminationdt date);
